...
**修复**
- 修复 Python.framework 符号链接签名问题

### v0.2.2 (2026-01-18)

**修复**
- 修复 macOS 公证时 Python framework 签名问题
- 正确签名 Python 解释器和打包的依赖库
...
**新功能**
- 顶栏添加模式状态标签，一目了然查看当前模式
- 支持点击标签快速切换工作/录音模式
- 外观设置中添加显示/隐藏开关

**改进**
- 移除模式切换的 Toast 提示（不再需要）
- 改进 macOS 托盘体验，统一配置存储
- 模块化 daemon.rs 架构，提升可维护性
